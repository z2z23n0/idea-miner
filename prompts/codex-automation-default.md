...
额外扫一层 trend radar sources：AI 新闻站、AI/builder newsletter、analyst newsletter 和 curated X/Twitter lists。默认可参考 The Decoder、VentureBeat AI、TLDR AI、The Batch、Latent Space / AI Engineer、Simon Willison、Import AI、SemiAnalysis、Stratechery、The Information AI Agenda，以及分开的 lab/platform、builder/devtool、market/reporter X lists。它们只负责发现新词、新 launch cluster、平台变化、成本/分发/公司战略变化和异常热度；不能单独支撑 final idea。由 radar 触发的候选，进入 final 前必须再用官方 docs/changelog/pricing、GitHub、HN/Reddit、Product Hunt、review、package/download、app/extension 评论或直接竞品页确认。
